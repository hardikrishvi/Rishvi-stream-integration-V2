...
{
    public class AdminUserAdminPermissionsSeed : BaseSeed
    {
        public AdminUserAdminPermissionsSeed(SqlContext context) : base(context)
        {
            OrderId = 500;
        }
        ...
        {
            if (!Context.Set<AdminPermission>().Any(w => w.DisplayName == "Admin Users"))
            {
        ...
        {
            var listPermission = AdminPermission.Create("Admin Users", AdminUsersPermission.List);
            ...
            var insertUpdateDeletePermissions = AdminPermission.CreateInsertUpdateDelete("Admin Users",
                AdminUsersPermission.List, listPermission.Id);
